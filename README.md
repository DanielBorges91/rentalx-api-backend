## rentalx-api-backend
API com Typescript para uma aplicação gerenciar o empréstimo de carros.
...
# Agendamento de aluguel dos carros

**RF**
- Deve ser possível cadastrar um aluguel.

**RN**
- O aluguel deve ter duração mínima de vinte e quatro horas.
